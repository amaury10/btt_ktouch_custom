...
/* ===== Panel Timings =====
 * Valeurs OFFICIELLES BTT, reprises telles quelles du firmware de base de la
 * plateforme (bigtreetech/PandaTouch_PlatformIO, src/pt/pt_board.h) pour le
 * panneau QX05ZJGI70N-05545Y. Les valeurs precedentes avaient ete divergees au
 * bring-up (PCLK 17 MHz, porches a moitie : 8/8/16/16) -> blanking trop court +
