...
/* Pourquoi ce fichier existe en double avec celui genere par Kconfig cote
 * ESP (firmware) : sur la cible, la configuration LVGL est produite par le
 * menu Kconfig d'ESP-IDF a partir de sdkconfig.defaults ; ici, hors ESP-IDF,
 * il n'y a pas de Kconfig, ce fichier est donc ecrit et maintenu a la main.
 * Les deux copies doivent rester alignees sur les valeurs qu'un ecran peut
 * voir : profondeur de couleur, polices Montserrat compilees, widgets
 * utilises, et LV_COLOR_MIX_ROUND_OFS. Toute derive entre les deux ferait
 * mentir le simulateur sur ce que l'appareil affiche reellement. */
...
#define LV_FONT_MONTSERRAT_14 1 /*deja actif dans le gabarit*/
